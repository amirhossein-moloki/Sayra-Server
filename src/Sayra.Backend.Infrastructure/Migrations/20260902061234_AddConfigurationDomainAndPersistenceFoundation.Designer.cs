...
namespace Sayra.Backend.Infrastructure.Migrations
{
    ...
    [Migration("20260902061234_AddConfigurationDomainAndPersistenceFoundation")]
    partial class AddConfigurationDomainAndPersistenceFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.ConfigurationPackage", b =>
                {
                    ...
                    b.Property<string>("SignerIdentity")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.AuthenticationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.CommunicationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MissedHeartbeats")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommunicationSessions", (string)null);
                });

            modelBuilder.Entity("Sayra.Backend.Domain.Entities.ConfigurationAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ConfigurationPackageId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ConfigurationTargetId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConfigurationPackageId", "ConfigurationTargetId", "IsActive")
                        .HasDatabaseName("IX_configuration_assignments_Package_Target_IsActive");

                    b.HasIndex("ConfigurationTargetId", "IsActive", "Priority")
                        .HasDatabaseName("IX_configuration_assignments_Target_IsActive_Priority");

                    b.ToTable("configuration_assignments", (string)null);
                });

            modelBuilder.Entity("Sayra.Backend.Domain.Entities.ConfigurationPublication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConfigurationPackageId", "Status")
                        .HasDatabaseName("IX_configuration_publications_Package_Status");

                    b.HasIndex("ConfigurationTargetId", "Status")
                        .HasDatabaseName("IX_configuration_publications_Target_Status");

                    b.ToTable("configuration_publications", (string)null);
                });

            modelBuilder.Entity("Sayra.Backend.Domain.Entities.ConfigurationTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("WorkstationEntityId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkstationEntityId")
                    ...
                    b.ToTable("configuration_targets", (string)null);
                });

            modelBuilder.Entity("Sayra.Backend.Domain.Entities.LoginAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.SecurityEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.UserResourceAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RoleId", "ResourceType", "ResourceId")
                        .HasDatabaseName("IX_UserResourceAccesses_Role_Type_Resource");

                    b.HasIndex("UserEntityId", "ResourceType", "ResourceId")
                        .HasDatabaseName("IX_UserResourceAccesses_User_Type_Resource");

                    b.ToTable("user_resource_accesses", (string)null);
                });
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.UserRoleEntity", b =>
                {
                    ...
                    b.HasIndex("UserEntityId", "RoleId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.RemoteCommand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("TargetWorkstationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TargetPcId");

                    b.HasIndex("TargetWorkstationId", "Status", "CreatedAt");
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.ConfigurationAssignment", b =>
                {
                    b.HasOne("Sayra.Backend.Domain.ConfigurationPackage", "Package")
                        .WithMany()
                        .HasForeignKey("ConfigurationPackageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sayra.Backend.Domain.Entities.ConfigurationTarget", "Target")
                        .WithMany()
                        .HasForeignKey("ConfigurationTargetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.Entities.ConfigurationTarget", b =>
                {
                    ...
                    b.HasOne("Sayra.Backend.Domain.Workstation", null)
                        .WithMany()
                        .HasForeignKey("WorkstationEntityId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
