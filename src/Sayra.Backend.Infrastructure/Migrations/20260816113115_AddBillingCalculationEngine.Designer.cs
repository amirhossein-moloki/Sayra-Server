...
namespace Sayra.Backend.Infrastructure.Migrations
{
    ...
    [Migration("20260816113115_AddBillingCalculationEngine")]
    partial class AddBillingCalculationEngine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.BillingResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<TimeSpan>("ConsumedDuration")
                    ...
                    b.ToTable("billing_results", (string)null);
                });
            ...
            modelBuilder.Entity("Sayra.Backend.Domain.BillingResult", b =>
                {
                    b.HasOne("Sayra.Backend.Domain.RateSnapshot", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Sayra.Backend.Shared.Money", "AdjustmentAmount", b1 =>
                        {
                            b1.Property<Guid>("BillingResultId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BillingResultId");

                            b1.ToTable("billing_results");

                            b1.WithOwner()
                                .HasForeignKey("BillingResultId");
                        });

                    b.OwnsOne("Sayra.Backend.Shared.Money", "DiscountAmount", b1 =>
                        {
                            b1.Property<Guid>("BillingResultId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Sayra.Backend.Shared.Money", "FinalAmount", b1 =>
                        {
                            b1.Property<Guid>("BillingResultId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Sayra.Backend.Shared.Money", "Subtotal", b1 =>
                        {
                            b1.Property<Guid>("BillingResultId")
                                .HasColumnType("uuid");
