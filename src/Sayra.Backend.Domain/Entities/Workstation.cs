...
namespace Sayra.Backend.Domain
{
    public class Workstation : BaseEntity
    {
        ...
        // Static compiled Regex for MAC address validation to avoid per-call allocation and regex parsing overhead during normalization
        ...
        public void NormalizeAndValidate()
        {
            ...
            // Standard MAC validation regex: 6 octets separated by colons (uses compiled static Regex to prevent heap allocations)
