...
namespace Sayra.Backend.Domain
{
    public class Workstation : BaseEntity
    {
        ...
        // Cached compiled regex for MAC address validation to avoid per-call heap allocation and parsing overhead
        ...
        public void NormalizeAndValidate()
        {
            ...
            // Validate MAC address format using compiled static regex to prevent unnecessary allocations
