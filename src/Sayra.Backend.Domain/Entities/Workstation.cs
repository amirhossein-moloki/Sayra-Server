...
namespace Sayra.Backend.Domain
{
    ...
    {
        // Performance Optimization: Cache compiled Regex instance for MAC address validation
        // to avoid per-call heap allocation and runtime regex parsing overhead during workstation validation.
