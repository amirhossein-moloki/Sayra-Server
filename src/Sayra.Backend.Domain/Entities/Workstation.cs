...
namespace Sayra.Backend.Domain
{
    ...
    {
        // Static compiled Regex for MAC address validation to prevent per-call instantiation, heap allocation, and parsing overhead
        ...
        public void NormalizeAndValidate()
        {
            ...
            // Standard MAC validation regex: 6 octets separated by colons (using static compiled regex)
